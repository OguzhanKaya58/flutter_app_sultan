...
class Character {
  ...
  List<Color> colors;
  final String date;
  final String boyChild;
  final String girlChild;
  final String father;
  final String mother;
...
List characters = [
  Character(
    name: "Osman Gazi",
    imagePath: "assets/images/OsmanGazi.png",
    description:
    ...
    colors: [Colors.purple.shade300, Colors.purple.shade600,Colors.purple.shade900],
    date: "(1299 – 1326)",
    boyChild:
    "Pazarlı Bey, Çoban Bey, Hamid Bey, Orhan Bey, Alaeddin Ali Bey, Melik Bey, Savcı Bey",
    girlChild: "Fatma Hatun",
  ...
  Character(
    name: "Orhan Gazi",
    imagePath: "assets/images/OrhanGazi.png",
    description:
    ...
    colors: [Colors.amber.shade300, Colors.amber.shade600,Colors.amber.shade900],
    date: "(1326 – 1359)",
    boyChild: "Süleyman Pasa, Murad Hüdavendigâr, Ibrahim, Halil, Kasım",
    girlChild: "Fatma Hatun",
    father: "Osman Gazi",
    mother: "Mal Hatun",
    birdDate: "1281",
  ...
  Character(
    name: "I.Murad",
    imagePath: "assets/images/I.Murad.png",
    description:
    ...
    colors: [Colors.pink.shade300, Colors.pink.shade600,Colors.pink.shade900],
    date: "(1359 – 1389)",
    boyChild: "Yakub Çelebi, Yıldırım Bayezid, Savcı Bey ve İbrahim",
    girlChild: "Nefise ve Sultan Hatun",
    father: "Orhan Gazi",
    mother: "Nilüfer Hatun",
    birdDate: "1326",
    dead: "1389",
    deathCause: "I. Kosova Savaşı'nda öldürüldü",
  ),
  Character(
    name: "I.Bayezıt",
    imagePath: "assets/images/I.Bayezid.png",
    description:
    "Yıldırım Bayezid 1360 yılında Edirne’de doğdu. Babası Murad Hüdavendigâr, annesi Gülçiçek Hatun’dur. Yıldırım Bayezid yuvarlak yüzlü, beyaz tenli, koç burunlu, elâ gözlü, kumral saçlı, sık sakallı ve geniş omuzluydu. Girdiği savaşlarda gösterdiği cesaretten ve hızlı hareket etmesinden dolayı ona ‘Yıldırım’ lakabı takılmıştı. Çocukluğunu Bursa Sarayı’nda kardeşleriyle birlikte geçirdi. İyi bir eğitim gördü. Devrin en büyük âlimlerinden dersler aldı. Gençliğinde Kütahya sancağında valilik yaptı. Sultan Murad Hüdavendigâr’ın vasiyeti gereği 1389 yılında padişahlığa getirildi. Tahta çıktığında 29 yaşındaydı. Sırbistan’ın başında, Kosova Savaşında ölen Kral Lazar’ın oğlu Stefan Lazareviç vardı. Barış antlaşması için geldiği Edirne’de kız kardeşi Maria’yı Bayezid’e verdi. Bu evlenme sayesinde Osmanlı-Sırp dostluğu kuruldu. Yıldırım Bayezid, Timur’la yaptığı Ankara Savaşı’nda yenildi ve esir düştü. 13 yıl süren saltanatı sonunda esaretinin başlamasından 7 ay 12 gün sonra vefat etti. ",
    colors: [Colors.lightGreen.shade300, Colors.lightGreen.shade600,Colors.lightGreen.shade900],
    date: "(1389 – 1402)",
    boyChild: "Musa Çelebi, Süleyman Çelebi, Mustafa Çelebi, İsa Çelebi, Mehmed Çelebi, Ertuğrul Çelebi, Kasım Çelebi",
    girlChild: "Fatma Sultan",
    father: "Murad Hüdavendigar",
    mother: "Gülçiçek Hatun",
    birdDate: "1360",
    dead: "8 Mart 1403",
    deathCause: "Eceliyle öldü",
  ),
  Character(
    name: "I.Mehmed",
    imagePath: "assets/images/I.Mehmed.png",
    description:
    "Sultan Çelebi Mehmed , 1389 yılında Edirne’de doğdu. Babası Yıldırım Bayezid, annesi de Germiyanoğulları’ndan Devlet Hatun’dur. Orta boylu, yuvarlak yüzlü, beyaz tenli, kırmızı yanaklı ve geniş göğüslüydü. Kuvvetli bir vücuda sahipti. Gayet hareketli ve cesurdu. Güreş yapar ve çok kuvvetli yay kirişlerini bile çekebilirdi. Padişahlığı süresince bizzat yirmi dört savaşa katılan Çelebi Mehmed, bu savaşlarda kırka yakın yara aldı. Başında kullanmış olduğu sarık, altın işlemeli kavuğu ile gayet güzel görünürdü. İçi kürklü ve yakası dik olan bir kaftan giyinirdi. Sultan Çelebi Mehmed Müslümanlara karşı göstermiş olduğu adaleti, aynı zamanda Hristiyan topluluklara karşı da gösterdi. İyi bir idareci ve politikacıydı. Tahsilini Bursa Sarayı’nda tamamladı. Daha sonra babası tarafından Amasya sancak beyliğine tayin edildi ve bu sırada devlet işlerini öğrendi. Fetret Devri’nden sonra Anadolu’daki beylikleri tekrar bir araya toplamayı başaran Sultan Çelebi Mehmed’e Osmanlı Devleti’nin ikinci kurucusu gözüyle de bakılabilir. Sultan Çelebi Mehmed 26 Mayıs 1421 de Edirne’de vefat etti. Ölüm haberi gizlendi. Osmanlı padişahları arasında ölümü gizlenen ilk padişah o oldu. Cenazesi Bursa’ya getirilerek Yeşil Türbe’ye defnedildi.",
    colors: [Colors.red.shade300, Colors.red.shade600,Colors.red.shade900],
    date: "(1413 – 1421)",
    boyChild: "Mustafa Çelebi, İkinci Murad, Ahmed, Yusuf, Mahmud",
    girlChild: "Fatma ve Selçuk Hatun",
    father: "Yıldırım Bayezid",
    mother: "Devlet Hatun",
    birdDate: "1389",
    dead: "26 Mayıs 1421",
    deathCause: "Eceliyle öldü",
  ...
  Character(
    name: "II.Murad",
    imagePath: "assets/images/II.Murad.png",
    description:
    ...
    colors: [Colors.teal.shade300, Colors.teal.shade600,Colors.teal.shade900],
    date: "(1421 – 1451)",
    boyChild: "Fatih Sultan Mehmed, Ahmed, Alâeddin, Orhan, Hasan, Ahmed",
    girlChild: "Şehzade ve Fatma Hatun",
    father: "Çelebi Mehmed",
    mother: "Emine Hatun",
    birdDate: "1402",
    dead: "3 Şubat 1451",
    deathCause: "Beyin Kanaması",
  ),
  Character(
    name: "II.Mehmed",
    imagePath: "assets/images/II.Mehmed.png",
    description:
    ...
    colors: [Colors.blue.shade300, Colors.blue.shade600,Colors.blue.shade900],
    date: "(1451 - 1481)",
    boyChild: "II.Bayezid, Şehzade Mustafa, Cem Sultan",
    girlChild: "Gevherhan Sultan",
    father: "İkinci Murad",
    mother: "Huma Hatun",
    birdDate: "29 Mart 1432",
    dead: "3 Mayıs 1481",
    deathCause: "Zehirlendiğinden dolayı öldüğü sanılmaktadır",
  ),
  Character(
    name: "II.Bayezid",
    imagePath: "assets/images/II.Bayezid.png",
    description:
    ...
    colors: [Colors.brown.shade300, Colors.brown.shade600,Colors.brown.shade900],
    date: "(1481 – 1512)",
    boyChild: "Mahmud, Ahmed, Sehinsah, Yavuz Sultan Selim, Mehmed, Korkud, Abdullah, Âlimsah",
    girlChild: "Aynisah, Gevher, Mülük Sultan, Hatice Sultan, Selçuk ve Hüma Hatun",
    father: "Fatih Sultan Mehmed",
    mother: "Mükrime Hatun",
    birdDate: "3 Aralık 1447",
    dead: "26 Mayıs 1512",
    deathCause: "Eceliyle öldü",
  ),
  Character(
    name: "Yavuz Sultan Selim",
    imagePath: "assets/images/YavuzSultanSelim.png",
    description:
  ...
  Character(
    ...
    colors: [Colors.amber.shade300, Colors.amber.shade600,Colors.amber.shade900],
    boyChild: "IV.Mehmed, II.Süleyman, II.Ahmed, Orhan, Bayezid, Cihangir, Selim, Murad",
    girlChild: "Ümmü Gülsüm Sultan, Peykan Sultan, Atike Sultan, Ayşe Sultan, Gevherhan Sultan",
    date: "(1640 – 1648)",
    father: "I.Ahmed",
    mother: "Mahfiruz Haseki Sultan",
    birdDate: "05 Kasım 1615",
    dead: "18 Ağustos 1648",
    deathCause: "Boğarak öldürülmüştür",
  ),
  Character(
    name: "IV.Mehmed",
    imagePath: "assets/images/IV.Mehmed.png",
    description:
    ...
    colors: [Colors.pink.shade300, Colors.pink.shade600,Colors.pink.shade900],
    boyChild: "II.Mustafa, III.Ahmed, Bayezid",
    girlChild: "Hatice Sultan, Safiye Sultan, Ümmü Gülsüm Sultan, Fatma Sultan",
    date: "(1648 – 1687)",
    father: "I.İbrahim",
    mother: "Turhan Hatice Sultan",
    birdDate: "02 Ocak 1642",
    dead: "06 Ocak 1693",
    deathCause: "Zaatüre",
  ),
  Character(
    name: "II.Süleyman",
    imagePath: "assets/images/II.Suleyman.png",
    description:
    ...
    birdDate: "15 Nisan 1642",
    dead: "22 haziran 1691",
    deathCause: "Böbrek Yetmezliği",
  ),
  Character(
    name: "II.Ahmed",
    imagePath: "assets/images/II.Ahmed.png",
    description:
    ...
    colors: [Colors.red.shade300, Colors.red.shade600,Colors.red.shade900],
    boyChild: "İbrahim, Selim",
    girlChild: "Atike Sultan, Hatice Sultan, Asiye Sultan",
    date: "(1691 – 1695)",
    father: "I.İbrahim",
    mother: "Hatice Muazzez Sultan",
    birdDate: "25 Şubat 1643",
    dead: "06 Şubat 1695",
    deathCause: "Edirne'de kalp yetmezliğinden dolayı vefat etti",
  ),
  Character(
    name: "II.Mustafa",
    imagePath: "assets/images/II.Mustafa.png",
    description:
  ...
  Character(
    ...
    colors: [Colors.pink.shade300, Colors.pink.shade600,Colors.pink.shade900],
    boyChild: "IV.Mustafa, II.Mahmud, Murad, Nusret, Mehmed, Ahmed, Süleyman",
    girlChild: "Esma, Emine, Rabia, Saliha, Alimşah, Dürrüşehvar, Fatma, Melikşah, Hibetullah Zekiye",
    date: "(1774 – 1789)",
    father: "III.Ahmed",
    mother: "Rabia Şermi Sultan",
    birdDate: "20 Mart 1725",
    dead: "07 Nisan 1789",
    deathCause: "Beyin Kanaması",
  ),
  Character(
    name: "III.Selim",
    imagePath: "assets/images/III.Selim.png",
    description:
    ...
    father: "III.Mustafa",
    mother: "Mihrişah Sultan",
    birdDate: "24 Aralık 1761",
    dead: "28 Temmuz 1808",
    deathCause: "Boğularak öldürüldü. Padişah IV. Mustafa'nın emriyle boğdurulmuştur. III. Selim ile onu idam etmeye gelen yeniçeriler arasında büyük bir boğuşma geçtiği söylenmektedir.",
  ),
  Character(
    name: "IV.Mustafa",
    imagePath: "assets/images/IV.Mustafa.png",
    description:
    ...
    colors: [Colors.red.shade300, Colors.red.shade600,Colors.red.shade900],
    girlChild: "Emine Sultan",
    date: "(1807 – 1808)",
    father: "I.Abdulhamid",
    mother: "Nüketseza Kadın Sultan",
    birdDate: "08 Eylül 1779",
    dead: "16 Kasım 1808",
    deathCause: "Boğularak Öldürüldü. IV. Mustafa, III. Selim'e yaptırdığının aynısını yaşadı. IV. Mustafa'yı askerlere boğdurtan ise II. Mahmud'du.",
  ),
  Character(
    name: "II.Mahmud",
    imagePath: "assets/images/II.Mahmud.png",
    description:
    ...
    colors: [Colors.teal.shade300, Colors.teal.shade600,Colors.teal.shade900],
    boyChild: "Abdülmecid, Abdülaziz, dört tane Ahmed isimli Şehzade, Bayezid, Abdülhamit, Süleyman, Mehmed, Murad, Nizameddin, Mehmed, Abdullah, Osman",
    girlChild: "Emine Sultan, Hamide Sultan, Hayriye Sultan, Şah Sultan, Saliha Sultan, Ayşe Sultan, Atike Sultan, Fatma Sultan, Münire Sultan, Fatma Sultan, Mihrimah Sultan, Adile Sultan",
    date: "(1808 – 1839)",
    father: "I.Abdulhamid",
    mother: "Nakşidil Valide Sultan",
    birdDate: "20 Temmuz 1785",
    dead: "01 Temmuz 1839",
    deathCause: "Verem",
  ),
  Character(
    name: "Abdülmecid",
    imagePath: "assets/images/I.Abdülmecid.png",
    description:
    ...
    date: "(1839 – 1861)",
    father: "II.Mahmud",
    mother: "Bezm-i Alem Valide Sultan",
    birdDate: "25 Nisan 1823",
    dead: "25 Haziran 1861",
    deathCause: "Tanzimat dönemini başlatan I. Abdülmecid de babasının kaderini yaşadı. Veremden vefat etti",
  ),
  Character(
    name: "Abdülaziz",
    imagePath: "assets/images/Abdülaziz.png",
    description:
    ...
    date: " (1861 – 1876)",
    father: "II.Mahmud",
    mother: "Pertevniyal Valide Sultan",
    birdDate: "08 Şubat 1830",
    dead: "04 Haziran 1876",
    deathCause: "Sultan İkinci Mahmud tahttan indirildikten birkaç gün sonra 4 Haziran 1876'da Feriye Sarayı'nda bilekleri kesilmiş bir halde bulunmuştur. Padişahın üzüntüden intihar ettiği söylense de öldürülmüş olma ihtimali de çok yüksektir",
  ),
  Character(
    name: "V.Murad",
    imagePath: "assets/images/V.Murad.png",
    description:
    ...
    date: "(1876 – 1876)",
    father: "Abdülmecid",
    mother: "Şevk Efza Kadın Efendi",
    birdDate: "21 Eylül 1840",
    dead: "29 Ağustos 1904",
    deathCause: "Tahtta en kısa süre kalan ve Osmanlı'nın ilk ve tek piyanist padişahı olan V. Murad şeker hastalığından dolayı vefat etmiştir",
  ),
  Character(
    name: "II.Abdülhamid",
    imagePath: "assets/images/II.Abdülhamit.png",
    description:
    ...
    date: "(1876 – 1909)",
    father: "Abdülmecid",
    mother: "Tir-i Müjgan Kadın Efendi",
    birdDate: "21 Eylül 1842",
    dead: "10 Şubat 1918",
    deathCause: "Verem",
  ),
  Character(
    name: "Mehmed Reşad",
    imagePath: "assets/images/V.Mehmed.png",
    description:
    ...
    date: "(1909 – 1918)",
    father: "Abdülmecid",
    mother: "Gülcemal Kadın Efendi",
    birdDate: "02 Kasım 1844",
    dead: "03 Temmuz 1918",
    deathCause: "Şeker",
  ),
  Character(
    name: "Mehmed Vahdeddin",
    imagePath: "assets/images/MehmedVahdeddin.png",
    description:
    ...
    father: "Abdülmecid",
    mother: "Gülcemal Kadın Efendi",
    birdDate: "02 Şubat 1861",
    dead: "15 Mayıs 1926",
    deathCause: "San-Remo'da 16 Mayıs 1926'da kalp krizinden vefat etmiştir.",
  ),
];
